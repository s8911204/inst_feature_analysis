...
def train(data_set, mdepth, mleaf):
    logging.info("Starting function train with data_set: %s, mdepth: %s, mleaf: %s", data_set, mdepth, mleaf)
    X, Y = xy(data_set)
...
def test(data_set, best_model):
    logging.info("Starting function test with data_set: %s, best_model: %s", data_set, best_model)
    X, Y = xy(data_set)
...
def final_report(result_set, out_dir):
    logging.info("Starting function final_report with result_set: %s, out_dir: %s", result_set, out_dir)
    acc_list = []
    recall_list = []
    precision_list = []
...
def persist_best_model(result_set, best_recall, out_dir):
    logging.info("Starting function persist_best_model with result_set: %s, best_recall: %s, out_dir: %s", result_set, best_recall, out_dir)
    idx = 0
    for result in result_set:
...
def get_feature_importance(model, feature_list):
    logging.info("Starting function get_feature_importance with model: %s, feature_list: %s", model, feature_list)
...
def plot_tree(model, run, feature_list, out_dir):
    logging.info("Starting function plot_tree with model: %s, run: %s, feature_list: %s, out_dir: %s", model, run, feature_list, out_dir)
